...
class AdsObject implements ArrayAccess, JsonSerializable
{
  /**
  ...
  /**
   * @return object The last response from the Ads API
   */
   ...
   * @param ApiResponse
   *
   * @return void Set the last response from the Ads API
   */
  ...
  public function &__get($k)
  {
    ...
    if (array_key_exists($k, $this->_values)) {
      ...
      $message = "Ads Notice: Undefined property of $class instance: $k. "
          . "HINT: The $k attribute was set in the past, however. "
          . "It was then wiped when refreshing the object "
          . "with the result returned by Ads's API, "
      ...
      $class = get_class($this);
      error_log("Ads Notice: Undefined property of $class instance: $k");
      return $nullval;
    }
  }
  // ArrayAccess methods
   ...
   * @param array $opts
   *
   * @return AdsObject The object constructed from the given values.
   */
  ...
  public function refreshFrom($values, $opts, $partial = false)
  {
    ...
    foreach ($values as $k => $v) {
      ...
      if (self::$nestedUpdatableAttributes->includes($k) && is_array($v)) {
        ...
        $this->_values[$k] = Util\Util::convertToAdsObject($v, $opts);
      }
  ...
  public function serializeParameters()
  {
    ...
    foreach (self::$nestedUpdatableAttributes->toArray() as $property) {
      if (isset($this->$property)) {
        if ($this->$property instanceof AdsObject) {
  ...
  {
    if ($recursive) {
      return Util\Util::convertAdsObjectToArray($this->_values);
    } else {
      return $this->_values;
    }
  }
